  ...
  addScript(config.script, 'Formio', function (Formio) {
    var renderForm = function renderForm() {
      ...
      Formio.createForm(formElement, form, config.config).then(function (instance) {
        ...
        wrapper.removeChild(loader); // Adding offline mode support if the plugin is provided.

        if (global('FormioOfflineProject')) {
          var projectUrl = config.project || new Formio(config.src).projectUrl;
          var FormioOfflineProject = global('FormioOfflineProject');
          var offlinePlugin = new FormioOfflineProject(projectUrl);
          debug('Registring offline plugin for project.', projectUrl);
          Formio.registerPlugin(offlinePlugin, "".concat(id, "-offline"));
          offlinePlugin.ready.then(function () {
