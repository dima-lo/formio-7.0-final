...
var Component = /*#__PURE__*/function (_Element) {
  ...
  _createClass(Component, [{
    ...
    value: function t(text) {
      ...
      if (text in _i18n.default.resources.en.translation && params._userInput) {
        return text;
      }
    ...
    value: function attachTooltips(toolTipsRefs) {
      ...
      toolTipsRefs.forEach(function (tooltip, index) {
        ...
        var tooltipText = _this5.interpolate(tooltip.getAttribute('data-title') || tooltipAttribute).replace(/(?:\r\n|\r|\n)/g, '<br />');
    ...
    get: function get() {
      ...
      var checkMask = function checkMask(value) {
        if (typeof value === 'string') {
          ...
          value = (0, _vanilla.conformToMask)(value, _this15.defaultMask, {
