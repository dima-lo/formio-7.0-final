  ...
  _createClass(EditGridComponent, [{
    ...
    value: function attach(element) {
      ...
      this.rowElements.forEach(function (row, rowIndex) {
        var _this4$dataValue$rowI;

        var editRow = _this4.editRows[rowIndex];

        if ((_this4$dataValue$rowI = _this4.dataValue[rowIndex]) !== null && _this4$dataValue$rowI !== void 0 && _this4$dataValue$rowI.isRowSelected) {
          ...
          [{
            ...
            action: function action() {
              ...
              if (Array.from(row.classList).includes('selected')) {
                _this4.dataValue[rowIndex].isRowSelected = true;
              } else {
                delete _this4.dataValue[rowIndex].isRowSelected;
                eventName = 'editGridUnSelectRow';
              }

              _this4.emit(eventName, {
                component: _this4.component,
                data: _this4.dataValue[rowIndex]
              });
            }
      ...
      return this.component.components.map(function (col, colIndex) {
        ...
        options.onChange = function (flags, changed, modified) {
          ...
          if (_this11.inlineEditMode) {
            ...
            var silentCheck = _this11.component.rowDrafts && !_this11.shouldValidateDraft(editRow);
      ...
      this.editRows.forEach(function (editRow, index) {
        ...
        if (_this14.rowRefs) {
          ...
          if (rowContainer) {
            ...
            if (!rowValid) {
              errorContainer.textContent = _this14.t('invalidRowError');
            }
          }
