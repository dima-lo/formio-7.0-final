...
var DynamicWizard = /** @class */ (function (_super) {
    ...
    DynamicWizard.prototype.attach = function (element) {
        ...
        if (!this.secondRender && this.root.page === 0 && this.shouldUpdate && this._visible && !this._disabled && !this.options.readOnly) {
        ...
        if (this.root.valueIsSet && this.isInitRowExists) {
